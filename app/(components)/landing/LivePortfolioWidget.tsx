...
export function LivePortfolioWidget() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        // Reuse the live performance summary used in-app
        ...
        // Sparkline still uses equity_curve for the overall shape (realized + unrealized)
        ...
        console.error("Failed loading live portfolio widget", e);
      }
    };
    load();
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div>
          ...
          <div className="text-2xl font-semibold">
            {winRate != null ? `${winRate}%` : <span className="text-muted-foreground/70 text-sm">Collecting trades…</span>}
          </div>
        </div>
        <div>
