    ...
    content: (
      <div className="space-y-3 text-sm sm:text-base text-muted-foreground leading-relaxed">
        <p>
          ...
          conditions deteriorate for a symboldfor example, prolonged low liquidity or structurally poor
          price actiondthat ticker may be temporarily removed from active coverage.
        </p>
        <p>
